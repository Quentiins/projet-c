...
int main(void)
{
    ...
    if (age < 11)
    {
        // Si l'âge est inférieur à 11 ans , alors les films pour enfants seront proposés. Si l'enfant répond non , deux autres films seront proposés sinon si l'enfant répond oui , le message lui indiquant d'aller dans la salle s'affiche.
    ...
    {
        // Si l'âge est entre 11 ans et 18 ans , alors les films pour ados seront proposés. Si l'ado répond non , deux autres films seront proposés sinon si il répond oui , le message lui indiquant d'aller dans la salle s'affiche.
    ...
    {
        // Si l'âge est supérieur à 18 ans , alors les films pour adultes seront proposés. Si l'adulte répond non , deux autres films seront proposés sinon si il répond oui , le message lui indiquant d'aller dans la salle s'affiche.
